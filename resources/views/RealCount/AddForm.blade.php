...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between py-3">
                    <h2 class="mb-sm-0">Tambah Real Count</h2>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Real Count</a></li>
    ...
    <div class="container header">
        <h5 class="title" id="formModalLabel">Form Real Count</h5>
    </div>
    <div class="Container">
        <form method="POST" action="{{ route('RealCount.insertData') }}" id="addForm" enctype="multipart/form-data">
            @csrf
