    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between py-3">
                    <h2 class="mb-sm-0">Quick Count</h2>
        ...
        <div class="row">
            @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'admin')
                <div class="col">
                    <a type="button" class="btn btn-primary mb-3" href="{{ route('QuickCount.insert') }}">
                        Tambah Quick Count
                    </a>
            @endif
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                dom: '<"row"<"col-md-6"B><"col-md-6 text-end"f>>rtip', // Mengatur posisi elemen
                buttons: [{
                        extend: 'csvHtml5',
                        text: 'Download CSV',
